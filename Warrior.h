 ...
 *               message.
 *
 *  - get_range: Returns the warriors range
 * 
 */ 
...
protected:
    ...
    virtual double get_range() const;      //const means the method won't modify the class   
    ...
    Warrior(int row, int col, int hit_points);
